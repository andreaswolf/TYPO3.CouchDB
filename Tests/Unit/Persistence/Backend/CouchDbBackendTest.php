...
class CouchDbBackendTest extends \TYPO3\Flow\Tests\UnitTestCase {
	...
	public function collectPropertiesSkipsInternalIdentifierProperty() {
		$object = $this->getMock('TYPO3\Flow\Aop\ProxyInterface');
		$object->foo = 'baz';
		$object->Flow_Persistence_Identifier = '9febd71d-da12-4c80-ae6e-a4edc24f9a57';
		...
		$properties = array(
			...
			'Flow_Persistence_Identifier' => array(
				'multivalue' => false,
				'type' => 'string'
			)
		);
		...
		$this->assertFalse(isset($properties['Flow_Persistence_Identifier']), 'Internal identifier property should be skipped');
	}
